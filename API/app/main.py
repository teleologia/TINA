...
async def transcribe_audio_endpoint(  
    ...
    # Sla het geüploade bestand tijdelijk op    temp_file_path = f"temp_{file.filename}"  
...
async def transcribe_with_timestamps_endpoint(  
    ...
    # Verwijder tijdelijke bestanden en directories    os.remove(temp_file_path)  
